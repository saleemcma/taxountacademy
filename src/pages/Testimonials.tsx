...
const reviews = [
  ...
  { name: "Yasha", country: "🇧🇪 Belgium", course: "Accounting", tutor: "Saleem Ali", text: "Saleem taught me BBA level accounts of Belgium. He knew all the concepts thoroughly and explained them clearly. I would recommend everyone to try taking a class with him and hopefully you won't be disappointed.", rating: 5 },
